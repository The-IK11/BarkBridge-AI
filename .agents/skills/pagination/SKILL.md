---
name: dart_pagination_implementation
description: Guidelines and instructions for implementing dynamic scroll pagination in the Flutter app using GetRx reactive fetch streams.
---

# Dart/Flutter scroll pagination implementation guidelines

When implementing list pagination (infinite scrolling) in this codebase, you must adhere strictly to the established reactive pattern present in [analyzed_history_screen.dart](file:///c:/Users/ibrah/ibrahims app/tintpin14_app/lib/feature/analyzed history/presenation/analyzed_history_screen.dart).
...
Use the reactive `GetRx` client to fetch and parse the data. 

> [!IMPORTANT]
> The dynamic endpoint url should contain limit and page queries, e.g. `Endpoints.somePath(limit, page)`.
